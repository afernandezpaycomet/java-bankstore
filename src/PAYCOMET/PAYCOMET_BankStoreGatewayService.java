...
/**
 * API de PAYCOMET para Java. Métodos BankStore IFRAME/FULLSCREEN/XML/JET
 *
 * NOTICE OF LICENSE
 *
 ...
 * @author Girish
 */
public class PAYCOMET_BankStoreGatewayService {
    ...
    private final String endpoint = "https://api.paycomet.com/gateway/xml-bankstore?wsdl";
    private final String endpointurl = "https://api.paycomet.com/gateway/ifr-bankstore?";

    public PAYCOMET_BankStoreGatewayService(String MERCHANT_MERCHANTCODE, String MERCHANT_TERMINAL, String Password, String MERCHANT_JETID, String IPAddr) {
	...
	*/    
    ...
    /**
     * 
     * @param dS_MERCHANT_JETTOKEN temporary user Token in PayCOMET
     * @return
     */
     ...
     * @return 
     */
    public ServiceResponse CreatePreauthorizationTokenUrl(String transreference, String amount, String currency,
            String iduser, String tokenuser, String lang, String description, String secure3d) {
        ServiceResponse result = new ServiceResponse();
        OperationData operation = new OperationData();
        try {
     ...
     * @return 
     */
    private String ComposeURLParams(OperationData operationdata, int operationtype) throws UnsupportedEncodingException {
        String secureurlhash = "";
        ...
        if (operationdata.getSecure3D() != null && !operationdata.getSecure3D().equals("false")) {
            data.put("3DSECURE", operationdata.getSecure3D());
        }
        data.put("MERCHANT_AMOUNT", operationdata.getAmount());
        if (operationdata.getConcept() != null && !operationdata.getConcept().equals("")) {
        ...
        while (it.hasNext()) {
            ...
            if( pair.getKey() != null && pair.getValue() != null ) {
                ...
                content += java.net.URLEncoder.encode(pair.getKey().toString(), java.nio.charset.StandardCharsets.UTF_8.toString()) + "=" + java.net.URLEncoder.encode(pair.getValue().toString(),java.nio.charset.StandardCharsets.UTF_8.toString());
        ...
        while (it.hasNext()) {
            ...
            if( pair.getKey() != null && pair.getValue() != null ) {
                ...
                secureurlhash += java.net.URLEncoder.encode(pair.getKey().toString(),java.nio.charset.StandardCharsets.UTF_8.toString()) + "=" + java.net.URLEncoder.encode(pair.getValue().toString(),java.nio.charset.StandardCharsets.UTF_8.toString());
                it.remove(); // avoids a ConcurrentModificationException
            
            }
        }
        return content+"&"+secureurlhash;
    }
